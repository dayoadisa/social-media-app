...
Post.prototype.cleanUp = function () {
  ...
  if (typeof this.data.language != "string") {
    this.data.language = "";
  }
...
Post.prototype.validate = function () {
  if (this.data.name == "") {
    this.errors.push("You must provide building name");
  }
  if (this.data.address == "") {
    this.errors.push("You must provide a address for new building");
  }
  if (this.data.language == "") {
    this.errors.push("You must select a language");
  }
};
